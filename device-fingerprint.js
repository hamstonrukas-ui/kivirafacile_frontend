...
// Conservé pour compatibilité avec le code existant qui appelle
// generateDeviceFingerprint() directement — redirige vers la version
// persistante pour éviter toute divergence.
async function legacyGenerateDeviceFingerprint() {
    return getDeviceFingerprint();
}

window.generateDeviceFingerprint = legacyGenerateDeviceFingerprint;

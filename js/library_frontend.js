        ...
        <div style="padding: 20px;">
            ...
            <div style="margin-top: 20px;">
                ${articles.map(article => {
                    const rawContent = article[`content_${lang}`] || article.content_fr || 'Contenu non disponible';
                    // Le contenu mélange deux styles : certains articles utilisent
                    // de vraies balises HTML (<h1>, <p>, <strong>...) qu'il faut
                    // laisser telles quelles, d'autres utilisent des \n littéraux
                    // comme simples marqueurs de saut de ligne. On ne touche donc
                    // qu'aux \n, sans jamais échapper les balises HTML.

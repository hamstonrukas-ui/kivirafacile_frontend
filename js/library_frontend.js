        ...
        <div style="padding: 20px;">
            ...
            <div style="margin-top: 20px;">
                ${articles.map(article => {
                    ...
                    // Le contenu en base contient des \n littéraux (texte, pas de
                    // vrais retours à la ligne) — on les convertit en <br> pour
                    // un affichage lisible. On échappe d'abord le HTML pour éviter
                    // tout problème d'injection, puis on remet les sauts de ligne.

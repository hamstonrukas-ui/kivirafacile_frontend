...
async function loadTranslationPaymentNumbers() {
    ...
    try {
        ...
        container.innerHTML = `
            <div class="operator-number"><span class="op-name">📱 Airtel Money</span><span class="op-num">+243 97 805 0574</span><span class="op-account" style="display:block;font-size:12px;color:#6b7280;">Mulezi Hamston</span></div>

...
let userMenuOpenedAt = 0; // horodatage de la dernière ouverture, sert de délai de grâce
...
document.addEventListener('click', function(e) {
    ...
    // Délai de grâce : on ignore les 400ms qui suivent l'ouverture, pour éviter
    // qu'un même geste de clic/tap referme le menu qu'il vient d'ouvrir
    // (certains navigateurs mobiles peuvent déclencher ce listener juste après l'ouverture).
    if (Date.now() - userMenuOpenedAt < 400) return;

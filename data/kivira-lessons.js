...
if (step3Check) {
   ...
   window.KiviraLessons = {
    ...
    // Recalcule et réaffiche chaque carte selon le statut premium réel
    // (renderCategories() gère déjà correctement le badge + le verrou par
    // catégorie — il ne faut PAS les effacer après coup sans condition,
    // sinon ça déverrouille visuellement même les catégories qui doivent
    // rester verrouillées à chaque appel de refresh()).
    refresh: function() {
